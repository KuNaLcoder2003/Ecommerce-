      ...
      <div className="w-[88%] m-auto p-[0.8rem] flex flex-col lg:flex-row items-center gap-[15px]">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col w-[70%] sm:w-[50%] md:w-[36%] h-full p-6 text-stone-800">
            <p className="text-lg font-medium mt-2">New Collection</p>
            <h2 className="text-3xl font-bold w-[200px]">{desc || "Discover Our Autumn Skincare"}</h2>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col w-[70%] sm:w-[50%] md:w-[36%] h-full p-6 text-stone-800">
            <p className="text-lg font-medium mt-2">New Collection</p>
            <h2 className="text-3xl font-bold w-[200px]">{desc1 || "Discover Our Autumn Skincare"}</h2>
